		...
		<div class="container">
			...
			<div class="row">
				<div class="col text-center">
					<h3
						class="text-uppercase font-weight-bold display-4 text-light banner-heading"> <strong>welcome
						to flyaway</strong></h3>
					<h3 class="display-4 text-light banner-heading pt-3 pb-4">Your
						journey is just click away</h3>
	...
	<footer>
		<div class="row justify-content-center">
			<div class="col-md-5 text-center">
				...
				<p>Fly Away provide best service</p>
				<strong>Contact Info</strong>
				<p>
					<i class="fas fa-phone-square pr-2 fa-2x text-success"></i>{92}
					9876-8888
				</p>
				<p>
					<i class="fas fa-envelope-open-text pr-2 fa-2x text-success"></i>supportadmin@flyaway.com
				</p>
